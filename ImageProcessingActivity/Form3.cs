...
namespace ImageProcessingActivity
{
    public partial class Form3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            visitedPixels = new bool[loaded.Width, loaded.Height];
            ...
            for (int x = 0; x < loaded.Width; x++)
            {
                for (int y = 0; y < loaded.Height; y++)
                {
                    ...
                    if (isBlack(current_pixel) && !visitedPixels[current_point.X, current_point.Y])
                    {
        ...
        private int getCoinArea(Point start_point)
        {
            ...
            visitedPixels[start_point.X, start_point.Y] = true;
            ...
            while (myQueue.Count > 0)
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    if (newX >= 0 && newX < loaded.Width && newY >= 0 && newY < loaded.Height && !visitedPixels[newX, newY])
                    {
